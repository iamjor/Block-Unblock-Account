...
// Accounts_login_model communicates with database and contains methods that will check if the account is blocked or not
class accounts_login_model extends CI_model{
    ...
    //sender
		$this->email->from('amauoed@gmail.com', 'Login Website');
		//recipient
		$this->email->to($email);
		//email subject
