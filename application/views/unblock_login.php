...
<!DOCTYPE html>
<!-- Unblock_login page is the page that contains the login form that will validate the user's request for unblocking his/her account. -->
<html lang="en">
<head>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-b-160 p-t-50">			
	                ...
	                echo form_open('account_login/unblock_verify','class="login100-form validate-form"');
